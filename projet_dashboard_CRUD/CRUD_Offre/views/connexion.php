...
if (!empty($_POST['Email']) && !empty($_POST['Password'])){
	...
	if ($t['user_email']==$_POST['Email'] && $t['user_pass']==$_POST['Password']) {
		...
		header("location:../../../ghaylene web/dashs/afficherclient.php");
...
if ($vide==false) { 
         ...
         echo '<meta http-equiv="refresh" content="0;URL=../../../ghaylene web/dashs/loginghaylene.php">'; 
      } 
}	  
 
else { 
      echo "Les variables du formulaire ne sont pas déclarées.<br> Vous devez remplir le formulaire"; 
     ?> <a href="location:../../../web/offre.php">Retour au formulaire</a>	 <?php 
}  
