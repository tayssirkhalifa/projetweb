...
<!--------------------------------------------Afficher Jeux-------------------------------------------------->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Jeux <br> Concours</h1>
					<div class="boutonAfficher" style="left: 600px;"> 
							<button type="button" class="btn btn-lg btn-primary">
 								<a href="afficherJeux.php">
								   <span>Afficher Concours  </span></a>
							</button>										
					</div>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					<div class="panel-heading">	
						<div class="formulaire">
							...
							<form method="POST" action="ajouterJeux.php" name="comment_form" enctype="multipart/form-data">
								<table >
									<h3>Ajouter Concours</h3> 
										<tr>
										<td> </td>
										<td><input type="hidden" name="id" style="height: 26px;"></td>
										</tr>    
									    <tr>
										<td>Titre :</td>
										<td><input type="text" name="titre" style="height: 26px;" data-validation="length" data-validation-length="min3"></td>
										</tr>
										<tr>
										<td>pts fedilité :</td>
										<td><input type="text" name="pt_fedilite" data-validation=" number" data-validation-allowing="rang[0;4000]" style="height: 26px;"></td>
										</tr>
										<tr>
										<td>Cadeau :</td>
										<td><input type="text" name="cadeau" required="" data-validation="length" data-validation-length="min1" style="height: 26px;"></td>
										</tr>
										<tr>
										<td>Image :</td>
										...
										<tr>
										<td>Date debut :</td>
										<td><input type="date" name="date_d" style="height: 26px;"></td>
										</tr>
										<tr>
										<td>Date fin :</td>
										...
										<tr>
										<td>participants :</td>
										<td><input type="text" name="participants" style="height: 26px;"></td>
										</tr>
										<tr>
										<td>Description :</td>
