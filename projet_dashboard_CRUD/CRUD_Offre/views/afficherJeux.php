...
<!----TRI---->
<form method="POST" action="afficherJeuxRecherche.php">
...
<td> <input type="submit" name="Chercher" value="Chercher Carte" placeholder="Chercher par Titre"></td>
</tr>
</table>
</form>
</div>
...
$jeux1C=new jeuxC();
$jeux1C->suppprimerJeuxAuto();
$listeJeux=$jeux1C->afficherJeuxBD2();
